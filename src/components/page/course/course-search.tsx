import { CoursesParams } from "@/client/course";
...
interface CourseSearchProps {
  handleFinish: (params: CoursesParams) => void;
}

const CourseSearch: React.FC<CourseSearchProps> = ({ handleFinish }) => {
  const [form] = useForm();
      ...
      <FormSearch>
        <FieldInline>
          <Form.Item label="기간" name="searchDateType" initialValue="created">
            <Select>
              <Select.Option value="created">수강일</Select.Option>
            </Select>
          </Form.Item>
